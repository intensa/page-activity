export default class PageActivity {
    constructor(element, setting = {}) {
        ...
        let defaultSettings = {
            achieveTime: 60,
            loop: 0,
            eventList: 'touchmove touchstart touchend blur focus focusin focusout load resize scroll unload click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup error',
            testPeriod: 10,
            useMultiMode: true,
            callBack: function (e) {
